<template>
  <div class="subcontent">
    ...
    <div class="row justify-center">
      <div style="display: flex; max-width: 800px; width: 100%; height: 280px">
        <q-calendar-task
          ref="calendar"
        ...
        >
          ...
          <template #footer-task="{ scope }">
            <div class="summary ellipsis">
              <div class="title ellipsis">{{ scope.footer.label }}</div>
  ...
  export default defineComponent({
    ...
    data() {
      return {
        ...
        titleTasks: [{ label: 'TITLE' }, { label: 'SUBTITLE' }],
        footerTasks: [{ label: 'TOTALS' }],
      }
    },
    computed: {
      /**
