<template>
  <q-layout view="hHh LpR fFf">
    ...
    <q-footer elevated class="glass">
      <q-toolbar>
        <div class="full-width text-center">
          This documentation site for QCalendar is a work in progress. If you see something missing
    ...
    <q-drawer v-model="leftDrawerOpen" show-if-above bordered aria-label="Menu" class="menu">
      <left-menu />
    </q-drawer>
    ...
    <q-page-container>
      <q-page>
        <theme-importer v-model="openThemeImporter" />
        <theme-editor
...
<script>
  ...
  import { today } from '@quasar/quasar-ui-qcalendar/src/Timestamp'
