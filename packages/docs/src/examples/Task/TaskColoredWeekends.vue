  ...
  methods: {
    ...
    weekdayClass(/*data*/) {
      ...
      return {
        ...
        'task__weekday--weekend': timestamp.weekday === 0 || timestamp.weekday === 6,
      }
    },
    ...
    dayClass(/*data*/) {
      ...
      return {
        ...
        'task__day--weekend': timestamp.weekday === 0 || timestamp.weekday === 6,
      }
    },
    ...
    footerDayClass(/*data*/) {
      ...
      return {
        ...
        'task__footer--weekend': timestamp.weekday === 0 || timestamp.weekday === 6,
      }
    },
