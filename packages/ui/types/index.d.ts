 ...
 */
export function createNativeLocaleFormatter (local : string, getOptions : TimestampFormatOptions): TimestampFormatter
/**
...
import { Timestamp, NumberArray, StringArray, ResourceObjectArray, ColumnObjectArray, TaskObjectArray, TitleObjectArray, FooterObjectArray, TimeObjectOrNumberOrString, TimestampOrNull, TimestampMoveOperation, TimestampArray, TimestampFormatOptions, TimestampFormatter, WeekdayFormatter, MonthFormatter } from './types'
